...
Route::get('/insertarEmpleado',['as'=>'insertarEmpleado','uses'=>'InsertarEmpleadoController@listarDepart']);
Route::get('/clientes', ['as'=>'clientes','uses'=>'ClienteController@get']);
Route::post('/insertarEmp', ['as' => 'insertEmp','uses'=>'EmpleadoController@insert']);
